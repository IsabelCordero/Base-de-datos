...
/*
    public Connection conexion(String usuario, String pass) {
        String cap = " ";
        ...
        try {
            ...
            if (cap.equals("Administrador")){
                this.setVisible(false);
                    ...
                    ingreso.pack();
                    Int.lblusu.setText(usuario);
            }
            
            if(!cap.equals("Administrador")){
                JOptionPane.showMessageDialog(this," No exixte dato ");
            }
    ...
    */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(user.equals("Usuario") && pass.equals("las carnitas")){
            Int pp = new Int();
            pp.setVisible(true);
            this.dispose();
        }
